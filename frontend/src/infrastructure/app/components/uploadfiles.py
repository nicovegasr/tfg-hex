...
def process_uploaded_files(algorithm_selected, filenames, contents):
    ...
    try:
        ...
        process_files_request = AlgorithmHttpRequester.process_files(uploaded_files_with_format)
        ...
        configuration_file_request = AlgorithmHttpRequester.get_configuration_file(algorithm)
        ...
        return [btn_result_component, {'visibility': 'visible'}, {'data': configuration_file_in_text}, {'data': uploaded_files_dataframes}, {'data': uploaded_files_with_format}]
    except:
